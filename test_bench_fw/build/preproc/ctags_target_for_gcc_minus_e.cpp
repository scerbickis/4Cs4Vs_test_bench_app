# 1 "C:\\Users\\Andrej Scerbickis\\OneDrive - Vilniaus Gedimino technikos universitetas\\Dokumentai\\univer\\bakalauras\\4Cs4Vs_test_bench_app\\test_bench_fw\\test_bench_fw.ino"
# 2 "C:\\Users\\Andrej Scerbickis\\OneDrive - Vilniaus Gedimino technikos universitetas\\Dokumentai\\univer\\bakalauras\\4Cs4Vs_test_bench_app\\test_bench_fw\\test_bench_fw.ino" 2
...
# 16 "C:\\Users\\Andrej Scerbickis\\OneDrive - Vilniaus Gedimino technikos universitetas\\Dokumentai\\univer\\bakalauras\\4Cs4Vs_test_bench_app\\test_bench_fw\\test_bench_fw.ino"
...
# 18 "C:\\Users\\Andrej Scerbickis\\OneDrive - Vilniaus Gedimino technikos universitetas\\Dokumentai\\univer\\bakalauras\\4Cs4Vs_test_bench_app\\test_bench_fw\\test_bench_fw.ino"
...
const float faze[] = {0, 2*3.1415926535897932384626433832795/3, 4*3.1415926535897932384626433832795/3}; //Kiekvienos fazės srovės signalų fazių poslinkių apibrėžimas (tarp kiekvienos 120 laipsnių)
...
# 49 "C:\\Users\\Andrej Scerbickis\\OneDrive - Vilniaus Gedimino technikos universitetas\\Dokumentai\\univer\\bakalauras\\4Cs4Vs_test_bench_app\\test_bench_fw\\test_bench_fw.ino"
...
# 104 "C:\\Users\\Andrej Scerbickis\\OneDrive - Vilniaus Gedimino technikos universitetas\\Dokumentai\\univer\\bakalauras\\4Cs4Vs_test_bench_app\\test_bench_fw\\test_bench_fw.ino"
  valdytiSAK(RASYTI_KODA_I_N_ATNAUJINTI_N,SAK1_adresas,u2); /*Antrojo SAK išėjimo įėjimo registro užpildymas antros fazės įtampos signalaso momentine verte
                                                                                                                          ...
                                                                                                                          ir SAK registro vertės atnaujinimo komandos siuntimas*/
# 106 "C:\\Users\\Andrej Scerbickis\\OneDrive - Vilniaus Gedimino technikos universitetas\\Dokumentai\\univer\\bakalauras\\4Cs4Vs_test_bench_app\\test_bench_fw\\test_bench_fw.ino"
  valdytiSAK(RASYTI_KODA_I_N_ATNAUJINTI_N,SAK2_adresas,u3); /*Trečiojo SAK išėjimo įėjimo registro užpildymas trečios fazės įtampos signalaso momentine verte
                                                                                                                          ...
                                                                                                                          ir SAK registro vertės atnaujinimo komandos siuntimas*/
# 108 "C:\\Users\\Andrej Scerbickis\\OneDrive - Vilniaus Gedimino technikos universitetas\\Dokumentai\\univer\\bakalauras\\4Cs4Vs_test_bench_app\\test_bench_fw\\test_bench_fw.ino"
  valdytiSAK(RASYTI_KODA_I_N_ATNAUJINTI_N,SAK3_adresas,uN); /*Ketvirtojo SAK išėjimo įėjimo registro užpildymas nulinio laido įtampos signalaso momentine verte
                                                                                                                          ...
                                                                                                                          ir SAK registro vertės atnaujinimo komandos siuntimas*/
# 110 "C:\\Users\\Andrej Scerbickis\\OneDrive - Vilniaus Gedimino technikos universitetas\\Dokumentai\\univer\\bakalauras\\4Cs4Vs_test_bench_app\\test_bench_fw\\test_bench_fw.ino"
  valdytiSAK(RASYTI_KODA_I_N_ATNAUJINTI_N,SAK4_adresas,i1); /*Penktojo SAK išėjimo įėjimo registro užpildymas pirmos fazės srovės signalaso momentine verte
                                                                                                                          ...
                                                                                                                          ir SAK registro vertės atnaujinimo komandos siuntimas*/
# 112 "C:\\Users\\Andrej Scerbickis\\OneDrive - Vilniaus Gedimino technikos universitetas\\Dokumentai\\univer\\bakalauras\\4Cs4Vs_test_bench_app\\test_bench_fw\\test_bench_fw.ino"
  valdytiSAK(RASYTI_KODA_I_N_ATNAUJINTI_N,SAK5_adresas,i2); /*Šeštojo SAK išėjimo įėjimo registro užpildymas antros fazės srovės signalaso momentine verte
                                                                                                                          ...
                                                                                                                          ir SAK registro vertės atnaujinimo komandos siuntimas*/
# 114 "C:\\Users\\Andrej Scerbickis\\OneDrive - Vilniaus Gedimino technikos universitetas\\Dokumentai\\univer\\bakalauras\\4Cs4Vs_test_bench_app\\test_bench_fw\\test_bench_fw.ino"
  valdytiSAK(RASYTI_KODA_I_N_ATNAUJINTI_N,SAK6_adresas,i3); /*Septintojo SAK išėjimo įėjimo registro užpildymas trečios fazės srovės signalaso momentine verte
                                                                                                                          ...
                                                                                                                          ir SAK registro vertės atnaujinimo komandos siuntimas*/
# 116 "C:\\Users\\Andrej Scerbickis\\OneDrive - Vilniaus Gedimino technikos universitetas\\Dokumentai\\univer\\bakalauras\\4Cs4Vs_test_bench_app\\test_bench_fw\\test_bench_fw.ino"
  valdytiSAK(RASYTI_KODA_I_N_ATNAUJINTI_N,SAK7_adresas,iN); /*Aštuntojo SAK išėjimo įėjimo registro užpildymas nulinio laido srovės signalaso momentine verte
                                                                                                                          ...
                                                                                                                          ir SAK registro vertės atnaujinimo komandos siuntimas*/
# 118 "C:\\Users\\Andrej Scerbickis\\OneDrive - Vilniaus Gedimino technikos universitetas\\Dokumentai\\univer\\bakalauras\\4Cs4Vs_test_bench_app\\test_bench_fw\\test_bench_fw.ino"
...
uint16_t generuotiHarmonikas(uint16_t amplitude, float f, float t, float faze, int aukstesniuHarmonikuSkaicius, char lyginumas){
  float signalas = amplitude * (sin(2*3.1415926535897932384626433832795*f*t + faze) + 1)/2; /*Pagrindinės įtampos signalo harmonikos apibrėžimas.

                                                              Sinusoidė yra pakelta ir normuota, taip kad jos verčių diapazonas yra

                                                              tarp 0 ir 1 imtinai.*/
# 134 "C:\\Users\\Andrej Scerbickis\\OneDrive - Vilniaus Gedimino technikos universitetas\\Dokumentai\\univer\\bakalauras\\4Cs4Vs_test_bench_app\\test_bench_fw\\test_bench_fw.ino"
  ...
  switch(lyginumas){
    case 'E': //E  reiškia 'Even' (lyginis)
      for(int h = 1; h<=aukstesniuHarmonikuSkaicius; h++){
        signalas += amplitude/(2*h) * (sin(2*h*(2*3.1415926535897932384626433832795*f*t + faze)))/2; /*Kiekvienos harmonikos amplitudė mažėja, o dažnis didėja du kart

                                                                        harmonikos indekso skaičiumi*/
# 140 "C:\\Users\\Andrej Scerbickis\\OneDrive - Vilniaus Gedimino technikos universitetas\\Dokumentai\\univer\\bakalauras\\4Cs4Vs_test_bench_app\\test_bench_fw\\test_bench_fw.ino"
      }
      break;
    case 'O': //O  reiškia 'Odd' (nelyginis)
      for(int h = 1; h<=aukstesniuHarmonikuSkaicius; h++){
        signalas += amplitude/(2*h+1) * (sin((2*h+1)*(2*3.1415926535897932384626433832795*f*t + faze)))/2;
    ...
    case 'B': //B  reiškia 'Both' (abu)
      for(int h = 1; h<=aukstesniuHarmonikuSkaicius; h++){
        signalas += amplitude/(h+1) * (sin((h+1)*(2*3.1415926535897932384626433832795*f*t + faze)))/2;
  ...
  return makeWord(signalas); // Grąžinamas signalas, konvertuotas į uint16_t tipą.
}
...
uint16_t gautiApkrovosImpedansa(float apkrova[], float f){
  ...
  if(apkrova[2]==0) Z = makeWord(sqrt(((apkrova[0])*(apkrova[0]))+((2*3.1415926535897932384626433832795*f*apkrova[1])*(2*3.1415926535897932384626433832795*f*apkrova[1])))); // Z=sqrt(R^2+XL^2)
  // Kitu atveju impedansas apskaičiuojamas pagal pilną formulę Z=sqrt(R^2+(XL-XC)^2)
  else Z = makeWord(sqrt(((apkrova[0])*(apkrova[0]))+((2*3.1415926535897932384626433832795*f*apkrova[1]-1/(2*3.1415926535897932384626433832795*f*apkrova[2]))*(2*3.1415926535897932384626433832795*f*apkrova[1]-1/(2*3.1415926535897932384626433832795*f*apkrova[2])))));
  return Z;
}
...
float gautiApkrovosFazesPoslinki(float apkrova[], float f){
  ...
  // Jeigu talpos vertė lygi nuliui, talpinė varža neapskaičiuojama, taip išvengiant dalybos iš nulio.
  if(apkrova[2]==0) phi = float(atan((2*3.1415926535897932384626433832795*f*apkrova[1])/apkrova[0])); // atan(XL/R)
  // Kitu atveju fazes poslinkis apskaičiuojamas pagal pilną formulę atan((XL-XC)/R)
  else phi = float(atan((2*3.1415926535897932384626433832795*f*apkrova[1]-1/(2*3.1415926535897932384626433832795*f*apkrova[2]))/apkrova[0]));
  return phi;
}
...
# 183 "C:\\Users\\Andrej Scerbickis\\OneDrive - Vilniaus Gedimino technikos universitetas\\Dokumentai\\univer\\bakalauras\\4Cs4Vs_test_bench_app\\test_bench_fw\\test_bench_fw.ino"
...
# 185 "C:\\Users\\Andrej Scerbickis\\OneDrive - Vilniaus Gedimino technikos universitetas\\Dokumentai\\univer\\bakalauras\\4Cs4Vs_test_bench_app\\test_bench_fw\\test_bench_fw.ino"
